...
export default function AllTenders() {
  ...
  const getDefaultTenders = (): Tender[] => [
    ...
    },
    {
      ...
      duration: "24 months",
      eligibility:
        "Category D ICT contractors with network infrastructure experience",
      requirements: [
    ...
    },
    {
      ...
      duration: "30 months",
      eligibility:
        "Category D contractors with water infrastructure experience",
      requirements: [
    ...
    },
    {
      ...
      duration: "8 months",
      eligibility:
        "Agricultural equipment suppliers with local service centers",
      requirements: [
    ...
    },
    {
      ...
      duration: "15 months",
      eligibility:
        "Security systems integrators with government project experience",
      requirements: [
    ...
    },
    {
      ...
      duration: "36 months",
      eligibility:
        "Environmental services companies with waste management expertise",
      requirements: [
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            All Procurement Tenders
          </h1>
          <p className="text-lg text-gray-600">
            Browse all available procurement opportunities from Kano State
            Government
          </p>
        </div>
          ...
          {filteredTenders.map((tender) => (
            ...
            >
              <div className="p-6">
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mb-3 ${getCategoryColor(tender.category)}`}
                >
                  {tender.category}
                </span>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <div className="flex items-center space-x-3 mt-2">
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium ${getStatusColor(selectedTender.status)}`}
                      >
                        {selectedTender.status}
                      </span>
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium ${getCategoryColor(selectedTender.category)}`}
                      >
