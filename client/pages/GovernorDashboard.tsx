...
const aiInsights = [
  {
    ...
    insight:
      "Based on current trends, procurement efficiency is projected to reach 92% by Q4 2024",
    confidence: 87,
    impact: "High",
    icon: Brain,
    color: "text-blue-600",
    bg: "bg-blue-50",
    recommendation:
      "Optimize tender evaluation process in Works & Infrastructure ministry",
  },
  {
    title: "Budget Optimization Opportunity",
    insight:
      "AI analysis suggests potential savings of ₦1.2B through contract consolidation",
    confidence: 93,
    impact: "Very High",
    icon: Calculator,
    ...
    bg: "bg-green-50",
    recommendation:
      "Implement bulk purchasing strategy for common items across MDAs",
  },
  {
    title: "Risk Alert: Delayed Projects",
    insight:
      "Pattern analysis indicates 15% probability of delays in infrastructure projects",
    confidence: 78,
    impact: "Medium",
    icon: AlertCircle,
    ...
    bg: "bg-orange-50",
    recommendation:
      "Deploy additional project management resources to high-risk projects",
  },
  {
    title: "Vendor Performance Insights",
    insight:
      "Top 10% of vendors deliver 23% faster than average, creating optimization potential",
    confidence: 91,
    impact: "High",
    icon: Sparkles,
    ...
    bg: "bg-purple-50",
    recommendation:
      "Establish preferred vendor program with performance incentives",
  },
];
...
const KPICard = ({ data }: { data: any }) => (
  ...
  >
    <div
      className={`absolute inset-0 bg-gradient-to-br ${data.gradient} opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity duration-500`}
    />
    <Card
      className={`relative border-0 ${data.shadowColor} shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden`}
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br ${data.bgGradient} opacity-50`}
      />
      <CardContent className="relative p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div
            className={`flex items-center text-sm font-medium ${data.trendDirection === "up" ? "text-green-600" : "text-red-600"}`}
          >
...
const AIInsightCard = ({ insight }: { insight: any }) => (
  <div
    className={`${insight.bg} border border-opacity-20 rounded-xl p-4 hover:shadow-lg transition-all duration-300 cursor-pointer group`}
  >
    <div className="flex items-start space-x-3 mb-3">
      <div
        className={`p-2 rounded-lg ${insight.color} bg-opacity-10 flex-shrink-0`}
      >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {project.category} • ₦{project.value}M
              </p>
            </div>
          </div>
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
          <div>
            ...
            <p className={`font-medium ${getRiskColor(project.risk)}`}>
              {project.risk}
            </p>
          </div>
          <div>
            ...
            <div className="mb-12">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
                  AI-powered strategic oversight of Kano State's procurement
                  ecosystem
                </p>
              </div>
            ...
            <Card className="border-0 shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 border-b">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">
                      Budget vs Spending vs Efficiency
                    </h3>
                    <p className="text-gray-600">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 border-b">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Category-wise excellence metrics
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 border-b">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600">
                    Quarterly performance and satisfaction trends
                  </p>
                </div>
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-6 border-b">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  ₦{topProjectsData.reduce((sum, p) => sum + p.value, 0)}M Total
                  Value
                </Badge>
              </div>
            </div>
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent className="p-6 space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl hover:shadow-md transition-all duration-300 group"
                >
                  <div className="flex items-center space-x-4">
                    <div className="p-2 rounded-lg bg-white shadow-sm">
                  ...
                  <div className="text-right">
                    ...
                    <Badge
                      variant="outline"
                      className={
                        zone.status === "High Activity"
                          ? "text-green-600 border-green-200 bg-green-50"
                          : zone.status === "Medium Activity"
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center justify-between p-3 bg-gradient-to-r from-white to-gray-50 rounded-lg"
                  >
                    <div>
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 border-b">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900">
                    Comprehensive Geographic Impact
                  </h3>
                  <p className="text-gray-600 text-sm">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="p-4 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300"
                >
        ...
        <Card className="border-0 shadow-xl overflow-hidden">
          <div className="relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div
                className="absolute bottom-8 left-1/4 w-4 h-4 bg-teal-400/30 rounded-sm rotate-12 animate-spin"
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    trend: "-3 days",
                    description: "Tender to award cycle",
                  },
                  {
                    icon: Shield,
                    value: "89%",
