  ...
  return (
    <div className="bg-gray-50 text-gray-900 min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a
                href="#home"
                className="flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium text-green-700 bg-green-50"
              >
              ...
              <a
                href="#tenders"
                className="flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-green-700"
              >
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/register"
                className="hidden sm:flex items-center px-4 py-2 bg-green-700 text-white rounded-md text-sm font-medium hover:bg-green-800"
              >
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t">
              <div className="space-y-2">
                <a
                  href="#home"
                  className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium text-green-700 bg-green-50"
                >
                  <Building2 className="h-4 w-4" />
                  <span>Home</span>
                </a>
                <a
                  href="#tenders"
                  className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-green-700"
                >
                  <FileText className="h-4 w-4" />
                  <span>Tenders</span>
                </a>
                ...
                <div className="pt-4 border-t space-y-2">
                  <Link
                    to="/login"
                    className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-green-700 w-full"
                  >
                  ...
                  <Link
                    to="/register"
                    className="flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium bg-green-700 text-white hover:bg-green-800 w-full"
                  >
      ...
      <main className="flex-1">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Stay informed with the latest procurement news, policy updates,
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-4">
                        Kano State introduces advanced AI technology to detect
                        and prevent fraudulent activities in procurement
                        processes, increasing security by 99.8%.
                      </p>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-500">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-4">
                        The portal has been recognized for outstanding
                        innovation in public procurement digitalization, setting
                        standards for other states.
                      </p>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-4">
                        New mobile application features real-time notifications,
                        offline document access, and streamlined bidding process
                        for contractors.
                      </p>
        ...
        <section className="py-20" id="about">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our platform is designed to make procurement fair, efficient,
                and transparent for both government agencies and vendors.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center hover:shadow-md transition-shadow border">
                ...
                <p className="text-gray-600">
                  Open and transparent procurement process with full audit
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center hover:shadow-md transition-shadow border">
                ...
                <p className="text-gray-600">
                  Fully digital procurement process reducing paperwork and
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center hover:shadow-md transition-shadow border">
                ...
                <p className="text-gray-600">
                  Equal opportunities for all qualified vendors through
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center hover:shadow-md transition-shadow border">
                ...
                <p className="text-gray-600">
                  Supporting local businesses and economic growth in Kano State.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* World Standards Compliance Section */}
        <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                KanoProc operates in full compliance with international procurement standards,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 border border-blue-100">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-medium">
                      International Excellence Standard
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Our procurement processes are fully aligned with the World Bank's
                    Procurement Framework, ensuring the highest standards of:
                  </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Value for Money</p>
                        <p className="text-sm text-gray-600">
                          Optimal combination of cost, quality, and performance
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="font-medium text-gray-900">Economy & Efficiency</p>
                        <p className="text-sm text-gray-600">
                          Streamlined processes for optimal resource utilization
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="font-medium text-gray-900">Equality & Transparency</p>
                        <p className="text-sm text-gray-600">
                          Fair competition and open procurement processes
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Clear audit trails and decision documentation
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 mt-6">
                    ...
                    <p className="text-sm text-blue-800">
                      This framework ensures our procurement practices meet global standards,
                      reducing risks and attracting international investments and partnerships.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 border border-green-100">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium">
                      OCDS Global Transparency Initiative
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    We implement the Open Contracting Data Standard (OCDS) to ensure
                    complete transparency and public access to procurement information:
                  </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Open Data Publication</p>
                        <p className="text-sm text-gray-600">
                          All procurement data published in machine-readable format
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Live tracking of procurement lifecycle and spending
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Citizen Engagement</p>
                        <p className="text-sm text-gray-600">
                          Public oversight and feedback mechanisms
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">Anti-Corruption Tools</p>
                        <p className="text-sm text-gray-600">
                          Enhanced detection and prevention of irregularities
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 mt-6">
                    ...
                    <p className="text-sm text-green-800">
                      By adopting OCDS, we join 50+ countries worldwide in promoting
                      transparency, enabling better value for money and reducing corruption risks.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-16 bg-white rounded-lg shadow-sm border p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Measurable improvements since implementing international standards
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-sm text-blue-800">Transparency Score</div>
                  <div className="text-xs text-gray-600 mt-1">vs. 67% national avg</div>
                </div>

                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-3xl font-bold text-green-600 mb-2">35%</div>
                  <div className="text-sm text-green-800">Cost Savings</div>
                  <div className="text-xs text-gray-600 mt-1">through competitive bidding</div>
                </div>

                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-3xl font-bold text-purple-600 mb-2">60%</div>
                  <div className="text-sm text-purple-800">Process Efficiency</div>
                  <div className="text-xs text-gray-600 mt-1">time reduction achieved</div>
                </div>

                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="text-3xl font-bold text-orange-600 mb-2">Zero</div>
                  <div className="text-sm text-orange-800">Corruption Cases</div>
                  <div className="text-xs text-gray-600 mt-1">since platform launch</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex items-center space-x-8">
                <div className="flex items-center space-x-3 px-6 py-3 bg-white rounded-lg shadow-sm border">
                  <Award className="h-6 w-6 text-blue-600" />
                  <div className="text-left">
                    <div className="text-sm font-medium text-gray-900">World Bank Certified</div>
                    <div className="text-xs text-gray-600">Procurement Framework</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 px-6 py-3 bg-white rounded-lg shadow-sm border">
                  ...
                  <div className="text-left">
                    <div className="text-sm font-medium text-gray-900">OCDS Compliant</div>
                    <div className="text-xs text-gray-600">Open Contracting Partnership</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Leveraging advanced AI technologies to make procurement smarter,
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      AI algorithms automatically match vendors with relevant
                      tenders based on their expertise, past performance, and
                      capacity, increasing bid quality by 40%.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Machine learning models analyze bidding patterns and
                      vendor behavior to detect anomalies and prevent fraudulent
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      AI forecasts project completion timelines, budget
                      requirements, and potential risks based on historical data
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Natural language processing automatically extracts and
                      validates information from tender documents, reducing
                        ...
                        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-600">
                                3 tenders can be combined for efficiency
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-600">
                                Top performers identified for fast-track
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-600">
                                Market price fluctuation detected
                              </p>
                            </div>
                          </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Real stories from contractors and government agencies
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border">
                ...
                <p className="text-green-800 text-sm mb-4">
                  "KanoProc has revolutionized our bidding process. The digital
                  submission system saved us 75% of the time we used to spend on
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border">
                ...
                <p className="text-blue-800 text-sm mb-4">
                  "The transparency and efficiency of KanoProc has helped us
                  procure medical equipment 60% faster. The AI fraud detection
                  gives us confidence in our vendor selection process."
                </p>
                <div className="text-xs text-blue-600">
                  <strong>Achievement:</strong> 50 healthcare centers equipped •
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border">
                ...
                <p className="text-purple-800 text-sm mb-4">
                  "As a small business, KanoProc leveled the playing field. The
                  digital platform eliminated barriers and gave us equal
                  opportunity to compete with larger companies."
                </p>
                <div className="text-xs text-purple-600">
                  <strong>Growth:</strong> 300% revenue increase • 25 new
                  employees hired
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Watch live as tenders are published, bids are submitted, and
                contracts are awarded across Kano State
              </p>
            </div>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-green-700">
                        Road Construction - ₦3.2B • Ministry of Works
                      </p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-blue-700">
                        Healthcare Equipment Tender • Dangote Construction
                      </p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-purple-700">
                        School Renovation Project • Northern Tech Solutions
                      </p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-yellow-700">
                        Kano Building Solutions Ltd • Category B
                      </p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-orange-700">
                        ICT Infrastructure Upgrade • Closes in 2 days
                      </p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-700">
                        Water Treatment Plant • Technical evaluation phase
                      </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Get expert support for all your procurement needs - from
                registration to contract management
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button className="text-left p-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Complete guide to company registration process
                  </p>
                </button>
                <button className="text-left p-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Required documents for different contractor categories
                  </p>
                </button>
                <button className="text-left p-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Step-by-step guide to submitting winning bids
                  </p>
                </button>
                <button className="text-left p-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Payment schedules and terms for contractors
                  </p>
                </button>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-xl text-green-100">
                Join thousands of registered vendors and access exclusive
                government procurement opportunities in Kano State.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/register"
                  className="inline-flex items-center px-8 py-4 bg-white text-green-700 rounded-lg font-medium hover:bg-gray-50"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 text-sm mb-4 max-w-md">
                Kano State Government's official e-procurement portal.
                Streamlining government procurement processes through digital
                transformation for transparency and efficiency.
              </p>
              <div className="text-xs text-gray-600">
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">
                    Kano State E-Procurement Guidelines
                  </h2>
                  <button
                    onClick={() => setShowGuidelines(false)}
                  ...
                  <section>
                    ...
                    <div className="bg-green-50 rounded-lg p-4 space-y-2">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm text-green-800">
                          <strong>Register Your Company:</strong> Complete the
                          online registration with all required documents
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <span className="flex-shrink-0 w-6 h-6 bg-green-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                        ...
                        <p className="text-sm text-green-800">
                          <strong>Get Approved:</strong> Wait for administrative
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm text-green-800">
                          <strong>Browse Tenders:</strong> Search and view
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm text-green-800">
                          <strong>Submit Bids:</strong> Purchase tender
                          documents and submit your proposals
                        </p>
                      </div>
                    </div>
                  </section>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 space-y-4">
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-blue-800">
                          <li>
                            • <strong>Evidence of Incorporation:</strong>{" "}
                            Certificate from Corporate Affairs Commission (CAC)
                          </li>
                          <li>
                            •{" "}
                            <strong>
                            ...
                            Including names of Directors with their addresses
                            and corresponding shares
                          </li>
                          <li>
                            • <strong>Key Personnel Details:</strong> Names,
                            CVs, and professional registration certificates with
                            recognized professional bodies
                          </li>
                          <li>
                            • <strong>Tax Clearance Certificates (TCC):</strong>{" "}
                          ...
                          <li>
                            ...
                            Of personnel assigned to execute the procurement
                          </li>
                          <li>
                            ��� <strong>Previous Experience:</strong> Evidence
                            of projects, programmes, and services executed with
                            Kano State Government or any other government agency
                            (national/international)
                          </li>
                          <li>
                            • <strong>Financial Capability:</strong> Bank
                            statements or audited company accounts
                          </li>
                          <li>
                            •{" "}
                            <strong>
                              List of Equipment and Infrastructure:
                            </strong>{" "}
                            To be physically verified
                          </li>
                          <li>
                            • <strong>Business Premises License</strong>
                          </li>
                          <li>
                            •{" "}
                            <strong>
                              Evidence of Registration with SCUML:
                            </strong>{" "}
                            Special Control Unit Against Money Laundering under
                            EFCC
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        <h4 className="font-medium text-blue-900 mb-2">
                          Sworn Court Affidavit (High Court of Justice)
                          Testifying That:
                        </h4>
                        <ul className="space-y-1 text-sm text-blue-800">
                          <li>
                            • The company is not in receivership or subject to
                            insolvency or bankruptcy
                          </li>
                          <li>
                            • The company is compliant with payment of taxes,
                            pensions, and social security obligations
                          </li>
                          <li>
                            • No director has been convicted for criminal
                            offenses relating to financial impropriety or
                            falsification
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        <h4 className="font-medium text-blue-900 mb-3">
                          Category of Contractors Registration & Fees:
                        </h4>
                      ...
                      <p className="text-xs text-blue-600 mt-3">
                        <strong>Note:</strong> All documents must be current,
                        properly notarized, and submitted with the appropriate
                        registration fee based on your category.
                      </p>
                    </div>
                  </section>
                    ...
                    <div className="bg-purple-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <ul className="text-sm text-purple-800 ml-4 space-y-1">
                          <li>
                            • Purchase tender documents with valid payment
                          </li>
                          <li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-purple-800 ml-4 space-y-1">
                          ...
                          <li>
                            • Submit before deadline (late submissions not
                            accepted)
                          </li>
                  ...
                  <section>
                    ...
                    <div className="bg-orange-50 rounded-lg p-4">
                      <p className="text-sm text-orange-800 mb-3">
                        Bids are typically evaluated based on:
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                    ...
                    <div className="bg-red-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <ul className="text-sm text-red-800 ml-4 space-y-1">
                          <li>
                            • Nigerian company registration (minimum 51%
                            Nigerian ownership)
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-red-800 ml-4 space-y-1">
                          <li>
                            • Bribery, corruption, or fraudulent practices
                          </li>
                    ...
                    <div className="bg-green-50 rounded-lg p-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-green-800">
                            Email: support@kanoproc.gov.ng
                          </p>
                          <p className="text-sm text-green-800">
                            Phone: +234 (0) 64 123-4567
                          </p>
                          <p className="text-sm text-green-800">
          ...
          <div className="flex items-start justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">
                    Kano State Procurement Policies
                  </h2>
                  <button
                    onClick={() => setShowPolicies(false)}
                    className="text-gray-400 hover:text-gray-600"
                ...
                <div className="max-h-96 overflow-y-auto space-y-6">
                  ...
                  <section>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 space-y-3">
                      <p className="text-sm text-blue-800">
                        <strong>Objective:</strong> To ensure transparency,
                        accountability, efficiency, and value for money in all
                        procurement activities of Kano State Government.
                      </p>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-blue-800">
                          <li>
                            • <strong>Transparency:</strong> All procurement
                            processes shall be conducted in an open and
                            transparent manner
                          </li>
                          <li>
                            • <strong>Competition:</strong> Fair and open
                            competition among qualified suppliers
                          </li>
                          <li>
                            • <strong>Accountability:</strong> Clear
                            responsibility and documentation for all procurement
                            decisions
                          </li>
                          <li>
                            • <strong>Value for Money:</strong> Optimal
                            combination of quality, price, and performance
                          </li>
                          <li>
                            • <strong>Integrity:</strong> Zero tolerance for
                            corruption and unethical practices
                          </li>
                          <li>
                            • <strong>Equality:</strong> Non-discrimination and
                  ...
                  <section>
                    ...
                    <div className="bg-green-50 rounded-lg p-4 space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-green-800">
                          Default method for procurement above ₦25 million. Open
                          to all qualified bidders with adequate notice period.
                        </p>
                        <p className="text-xs text-green-600 mt-1">
                          <strong>Timeline:</strong> Minimum 30 days notice
                          period
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-800">
                          For specialized goods/services where limited qualified
                          suppliers exist. Pre-qualification required.
                        </p>
                        <p className="text-xs text-green-600 mt-1">
                          <strong>Threshold:</strong> ₦10 million - ₦25 million
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-800">
                          For procurement below ₦10 million or emergency
                          situations with proper justification.
                        </p>
                        <p className="text-xs text-green-600 mt-1">
                          <strong>Approval:</strong> Requires MDA head approval
                          with justification
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-600 mt-1">
                          <strong>Process:</strong> Simplified procurement with
                          shorter timelines
                        </p>
                      </div>
                    </div>
                        ...
                        <table className="min-w-full text-sm text-purple-800">
                          ...
                          <tbody className="space-y-1">
                            ...
                            <tr className="border-b border-purple-100">
                              ...
                              <td className="py-2">
                                Open competitive bidding mandatory
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 font-medium">
                  ...
                  <section>
                    ...
                    <div className="bg-orange-50 rounded-lg p-4 space-y-3">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-orange-800 ml-4 space-y-1">
                          <li>
                            • Regular performance evaluations for all
                            contractors
                          </li>
                          <li>
                            • Quality assurance and delivery timeline tracking
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-orange-800 ml-4 space-y-1">
                          <li>
                            • Suspension for poor performance or contract
                            violations
                          </li>
                          <li>
                            • Debarment for fraudulent activities or corruption
                          </li>
                          <li>• Appeals process for contested sanctions</li>
                          <li>
                            �� Rehabilitation program for suspended vendors
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-red-800">
                          Kano State Government maintains zero tolerance for
                          corruption in all forms including bribery, kickbacks,
                          conflicts of interest, and fraudulent practices.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-red-800 ml-4 space-y-1">
                          <li>
                            • Offering or accepting bribes, gifts, or favors
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-red-800 ml-4 space-y-1">
                          <li>
                            • Anonymous whistleblower hotline: 0800-REPORT
                          </li>
                          <li>
                            • Online reporting portal: report.kanoproc.gov.ng
                          </li>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 ml-4 space-y-1">
                          <li>
                            • Designated contract managers for all major
                            contracts
                          </li>
                          <li>
                            • Regular progress monitoring and milestone tracking
                          </li>
                          <li>
                            • Quality assurance and compliance verification
                          </li>
                          <li>
                            • Change order procedures and approval protocols
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 ml-4 space-y-1">
                          <li>
                            • Standard payment terms: 30 days upon delivery and
                            acceptance
                          </li>
                          <li>
                            • Advance payments limited to 15% with bank
                            guarantee
                          </li>
                          <li>
                            • Retention of 5-10% for defect liability period
                          </li>
                          <li>
                            • Performance-based payment schedules for service
                            contracts
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <ul className="text-sm text-green-800 ml-4 space-y-1">
                          ...
                          <li>
                            • Energy efficiency considerations in procurement
                            decisions
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-green-800 ml-4 space-y-1">
                          <li>
                            • Minimum 60% Nigerian content for goods and
                            services
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-green-800 ml-4 space-y-1">
                          <li>
                            • Community development and job creation priorities
                          </li>
                          <li>
                    ...
                    <div className="bg-indigo-50 rounded-lg p-4 space-y-3">
                      <div>
                        ...
                        <ul className="text-sm text-indigo-800 ml-4 space-y-1">
                          <li>
                            • Internal audit of all procurement activities
                          </li>
          ...
          <div className="flex items-start justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <section>
                    ...
                    <div className="bg-green-50 rounded-lg p-4">
                      <ul className="space-y-2">
                        {selectedTender.technicalSpecs.map(
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-purple-800">
                              Complete online registration and get approved
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-purple-800">
                              Pay {selectedTender.tenderFee} tender fee and
                              download documents
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-purple-800">
                              Submit technical and financial proposals before
                              deadline
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-purple-800">
                              Evaluation results will be communicated within 30
                              days
                            </p>
                          </div>
                        </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 flex justify-between items-center">
                  <div className="text-sm text-gray-500">
                    Views: {selectedTender.views} • Published:{" "}
                    {new Date(selectedTender.publishDate).toLocaleDateString()}
                  </div>
                  <div className="flex space-x-3">
                    <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                      <Download className="h-4 w-4 mr-2" />
