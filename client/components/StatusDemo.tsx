  ...
  return (
    <div className="fixed top-4 right-4 z-50 bg-white rounded-lg shadow-lg border p-4 max-w-sm">
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded text-xs text-gray-600">
        <strong>Notice:</strong> This demo panel shows how the dashboard
        dynamically adapts based on user status. In production, status would be
        determined by actual registration and approval processes.
      </div>
    </div>
  );
};
