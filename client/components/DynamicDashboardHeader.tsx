...
export const DynamicDashboardHeader: React.FC<DynamicDashboardHeaderProps> = ({
  ...
  const statusConfigs = {
    ...
    Suspended: {
      ...
      secondaryAction: { text: 'View Compliance', section: 'detailed-compliance' },
    },
    Blacklisted: {
      icon: Ban,
  ...
  const getStatusAlert = () => {
    const alertConfigs = {
      Pending: {
        ...
        message: 'Your company registration is being processed by the Bureau of Public Procurement.',
        type: 'info' as const,
        details: companyData.suspensionReason,
      },
      Approved: {
        title: 'Account Active',
        message: 'Your company has full access to all procurement opportunities.',
      ...
      Blacklisted: {
        ...
        message: 'Your company is currently blacklisted from state procurements.',
        type: 'error' as const,
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className={`bg-gradient-to-r ${currentConfig.bgGradient} rounded-lg p-6`}>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-4">
              <div className={`p-3 rounded-lg bg-white shadow-sm`}>
                <StatusIcon className={`h-6 w-6 text-${currentConfig.actionColor}-600`} />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-gray-700">{config.statusDescription}</p>
              </div>
              <div>
            ...
            <div className="flex space-x-3">
              <button
                onClick={() => onSectionChange(currentConfig.primaryAction.section)}
              ...
              <button
                onClick={() => onSectionChange(currentConfig.secondaryAction.section)}
            ...
            <div key={index} className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className={`text-3xl font-bold text-${metric.color}-600 mt-1`}>
                    {metric.value}
                  </p>
