...
export function ProcurementActivitySummary({
  data,
  onFilterChange,
}: ProcurementActivitySummaryProps) {
  ...
  const nocApprovalRate =
    totalNOC > 0 ? (data.approvedNOC / totalNOC) * 100 : 0;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            System-wide procurement and tender activities across all MDAs
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Across all MDAs</p>
          </CardContent>
        </Card>
      ...
      <Card className="border-border">
        <CardHeader>
          <CardTitle className="text-lg font-semibold">
            No Objection Certificate (NOC) Requests
          </CardTitle>
          <CardDescription>
            Status overview of NOC requests across all MDAs
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-border">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-lg font-semibold">
                High-Value Contracts (Top 5)
              </CardTitle>
              <CardDescription>
                Recently awarded contracts with highest values
              </CardDescription>
            </div>
        ...
        <CardContent>
          {data.highValueContracts.length > 0 ? (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span>
                          Awarded:{" "}
                          {new Date(contract.dateAwarded).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                No high-value contracts available
              </p>
            </div>
          )}
        </CardContent>
