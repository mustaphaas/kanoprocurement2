...
export function UserCommitteeActivity({ data }: UserCommitteeActivityProps) {
  ...
  const totalRoles = Object.values(data.roleDistribution).reduce((sum, count) => sum + count, 0);

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">User & Committee Activity</h2>
          <p className="text-muted-foreground">Monitor user engagement and committee management across MDAs</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{data.activeCommittees}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card className="border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{data.assignedMembers}</div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card className="border-border">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>User roles across all MDAs in the procurement system</CardDescription>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`p-2 bg-white rounded-full border ${role.borderColor}`}>
            ...
            {/* Visual Distribution */}
            <div className="space-y-4">
              <h4 className="font-medium text-foreground">Distribution Overview</h4>
      ...
      <Card className="border-border">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-lg font-semibold">Active Evaluation Committees</CardTitle>
              <CardDescription>Currently operational committees across all MDAs</CardDescription>
            </div>
        ...
        <CardContent>
          {data.committees.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">No active committees found</p>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="border-border">
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Committee Performance Summary</CardTitle>
          <CardDescription>Key metrics for committee efficiency and performance</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="text-2xl font-bold text-green-600">87%</div>
              <p className="text-sm text-green-700">Committees with Full Membership</p>
            </div>
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <p className="text-sm text-purple-700">Avg. Days per Evaluation</p>
            </div>
          </div>
        </CardContent>
      </Card>
