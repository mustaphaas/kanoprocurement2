...
export default function MDAForm({
  ...
  const [formData, setFormData] = useState({
    ...
    type: initialData?.type || 'ministry' as 'ministry' | 'department' | 'agency',
  ...
  const validateForm = () => {
    ...
    if (formData.settings.procurementThresholds.level2 <= formData.settings.procurementThresholds.level1) {
      newErrors.level2 = 'Level 2 threshold must be greater than Level 1';
    }

    if (formData.settings.procurementThresholds.level3 <= formData.settings.procurementThresholds.level2) {
      newErrors.level3 = 'Level 3 threshold must be greater than Level 2';
    }

    if (formData.settings.allowedCategories.length === 0 || 
        (formData.settings.allowedCategories.length === 1 && !formData.settings.allowedCategories[0])) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cleanedData = {
        ...
        settings: {
          ...formData.settings,
          allowedCategories: formData.settings.allowedCategories.filter(cat => cat.trim() !== '')
        }
      };
  ...
  const updateCategory = (index: number, value: string) => {
    setFormData(prev => ({
      ...
      settings: {
        ...prev.settings,
        allowedCategories: prev.settings.allowedCategories.map((cat, i) => i === index ? value : cat)
      }
    }));
  };
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="parentMDA" className="block text-sm font-medium text-gray-700 mb-2">
                        Parent MDA
                      </label>
                      <select
                        id="parentMDA"
                        value={formData.parentMDA}
                        onChange={(e) => setFormData(prev => ({ ...prev, parentMDA: e.target.value }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="headOfMDA" className="block text-sm font-medium text-gray-700 mb-2">
                        Head of MDA *
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, headOfMDA: e.target.value }))}
                          className={`w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                            errors.headOfMDA ? 'border-red-300' : 'border-gray-300'
                          }`}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="budgetYear" className="block text-sm font-medium text-gray-700 mb-2">
                        Budget Year *
                      </label>
                      <div className="relative">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({
                            ...prev,
                            settings: { ...prev.settings, totalBudget: parseInt(e.target.value) || 0 }
                          }))}
                          className={`w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Procurement Approval Thresholds</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label htmlFor="level1" className="block text-sm font-medium text-gray-700 mb-2">
                        Level 1 - MDA Head (₦) *
                      </label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label htmlFor="level2" className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <div>
                      <label htmlFor="level3" className="block text-sm font-medium text-gray-700 mb-2">
                ...
                {/* Allowed Categories */}
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Allowed Procurement Categories</h3>
                  <div className="space-y-3">
                    {formData.settings.allowedCategories.map((category, index) => (
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                          ...prev,
                          settings: { ...prev.settings, customWorkflows: e.target.checked }
                        }))}
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                      />
                      <span className="text-sm text-gray-700">Enable custom procurement workflows</span>
                    </label>
                  </div>
                </div>
              </div>
