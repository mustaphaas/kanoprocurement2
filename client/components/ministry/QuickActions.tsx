      ...
      <div className="space-y-6">
        {Object.entries(groupedActions).map(([category, actions]) => {
          ...
          return (
            <div
              key={category}
              className="bg-white/80 backdrop-blur-sm rounded-xl border border-teal-100 shadow-lg p-6"
            >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4">
                        {/* Action Icon */}
                        <div
                          className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center bg-white shadow-lg border-2 ${colors.border}`}
                        >
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm">
                  Essential workflow shortcuts for efficient procurement
                  management
                </p>
              </div>
            </div>
