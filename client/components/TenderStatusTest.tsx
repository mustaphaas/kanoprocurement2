...
export default function TenderStatusTest() {
    ...
    const initializeTestTenders = () => {
      ...
      const testData: TestTender[] = [
        ...
        },
        {
          ...
          description:
            "Within default 5-day threshold - should be Closing Soon",
        },
      ];
  ...
  const runStatusTests = () => {
    ...
    testTenders.forEach((tender) => {
      ...
      const daysRemaining = tenderStatusChecker.calculateDaysUntilDeadline(
        tender.closingDate,
      );
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 font-medium">
                  Verify automatic status transitions and submission
                  restrictions
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              ...
              <Badge variant="outline">
                {settings.closingSoonThresholdDays} days
              </Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              ...
              <Badge
                variant={
                  settings.autoTransitionEnabled ? "default" : "secondary"
                }
              >
            ...
            <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
              ...
              <Badge
                variant={
                  settings.autoEvaluationStartEnabled ? "default" : "secondary"
                }
              >
                  ...
                  <div>
                    ...
                    <p
                      className={
                        daysRemaining < 0
                          ? "text-red-600"
                          : daysRemaining <= settings.closingSoonThresholdDays
                            ? "text-orange-600"
                            : "text-green-600"
                      }
                    >
                ...
                {result && (
                  <div className="bg-gray-50 rounded-lg p-3 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        <span className="text-gray-600">Should Evaluate:</span>{" "}
                        {result.shouldStartEvaluation ? "Yes" : "No"}
                      </div>
                      <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-orange-50 rounded-lg border border-orange-200">
                <div className="text-2xl font-bold text-orange-700">
                  {
                    Object.values(testResults).filter(
                      (r) => r.automaticStatus === "Closing Soon",
                    ).length
                  }
                </div>
