...
export const fixTenderSettingsIssue = () => {
  ...
  if (currentSettings.closingSoonThresholdDays === 0 || !currentSettings.autoTransitionEnabled) {
    console.log("❌ Found issue: Threshold is 0 or auto-transition disabled");
    tenderSettingsManager.resetToDefaults();
    console.log("✅ Reset to defaults: closingSoonThresholdDays=5, autoTransitionEnabled=true");
  } else {
