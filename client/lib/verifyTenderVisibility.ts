...
export const logTenderVisibilityStatus = (): void => {
  ...
  console.log("\nDetailed Breakdown:");
  console.log(
    `📦 Main Storage (kanoproc_tenders): ${result.details.mainStorage.totalTenders} total, ${result.details.mainStorage.ministryTenders} for current ministry`,
  );
  console.log(
    `🏛️ Ministry Overview: Will show ${result.details.ministryOverview.willShow} tenders (should show ${result.details.ministryOverview.shouldShow})`,
  );
  console.log(
    `🏢 Company Dashboard: Will show ${result.details.companyDashboard.willShow} tenders (should show ${result.details.companyDashboard.shouldShow})`,
  );
  console.log(
    `🏠 Homepage Featured: Will show ${result.details.homepage.willShow} tenders (should show ${result.details.homepage.shouldShow})`,
  );
...
export const testTenderCreationFlow = (): void => {
  ...
  console.log(
    "BEFORE: Ministry overview shows",
    beforeResult.details.ministryOverview.willShow,
    "tenders",
  );
