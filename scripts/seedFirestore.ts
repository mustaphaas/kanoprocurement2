    ...
    const tenders = [
      {
        ...
        closeDate: Timestamp.fromDate(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)),
        bidsReceived: 0,
        ocdsReleased: true,
        addendaCount: 0,
        eligibilityCriteria: 'Registered medical equipment suppliers with CAC registration',
        technicalRequirements: 'ISO certified medical equipment with 2-year warranty',
        evaluationCriteria: 'Technical capability (40%), Financial proposal (60%)',
      ...
      },
      {
        ...
        status: 'Published',
        publishDate: Timestamp.now(),
        closeDate: Timestamp.fromDate(new Date(Date.now() + 45 * 24 * 60 * 60 * 1000)),
        bidsReceived: 0,
        ocdsReleased: true,
        addendaCount: 0,
        eligibilityCriteria: 'Registered construction companies with relevant experience',
        technicalRequirements: 'Minimum 5 years experience in road construction',
        evaluationCriteria: 'Technical capability (50%), Financial proposal (50%)',
      ...
      },
      {
        ...
        currency: 'NGN',
        status: 'Awarded',
        publishDate: Timestamp.fromDate(new Date(Date.now() - 60 * 24 * 60 * 60 * 1000)),
        closeDate: Timestamp.fromDate(new Date(Date.now() - 30 * 24 * 60 * 60 * 1000)),
        openDate: Timestamp.fromDate(new Date(Date.now() - 25 * 24 * 60 * 60 * 1000)),
        awardDate: Timestamp.fromDate(new Date(Date.now() - 10 * 24 * 60 * 60 * 1000)),
        ...
        addendaCount: 1,
        evaluationScore: 92,
        eligibilityCriteria: 'Registered ICT companies with relevant certifications',
        technicalRequirements: 'Cisco/Microsoft certified engineers, minimum 3 years experience',
        evaluationCriteria: 'Technical capability (60%), Financial proposal (40%)',
    ...
    const contracts = [
      {
        ...
        expectedEndDate: Timestamp.fromDate(new Date(Date.now() + 200 * 24 * 60 * 60 * 1000)),
        status: 'Active',
        progress: 25,
        milestones: [
          {
            ...
            expectedDate: Timestamp.fromDate(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)),
            status: 'In Progress',
          ...
          },
          {
            ...
            expectedDate: Timestamp.fromDate(new Date(Date.now() + 90 * 24 * 60 * 60 * 1000)),
            status: 'Pending',
    ...
    const notifications = [
      {
        ...
        message: 'A new tender for Hospital Equipment Supply has been published.',
        read: false,
        createdAt: Timestamp.now(),
        relatedType: 'tender',
      ...
      },
      {
        ...
        message: 'Your Tax Clearance Certificate expires in 30 days. Please update to avoid suspension.',
        read: false,
        createdAt: Timestamp.now(),
        relatedType: 'system'
      },
      {
        ...
        message: 'Congratulations! You have been awarded the ICT Infrastructure Upgrade contract.',
        read: true,
